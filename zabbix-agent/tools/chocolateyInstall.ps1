...
$id             = 'zabbix-agent'
$title          = 'Zabbix Agent'
$url            = 'https://cdn.zabbix.com/zabbix/binaries/stable/5.0/5.0.31/zabbix_agent-5.0.31-windows-i386-openssl.zip'
$url64          = 'https://cdn.zabbix.com/zabbix/binaries/stable/5.0/5.0.31/zabbix_agent-5.0.31-windows-amd64-openssl.zip'
$checksum       = 'b48acd6acfd48f34555e39c3b1267d6fbd9ba6c65ae0df1826c44c9bf25d8e16'
$checksumType   = 'sha256'
$checksum64     = '42131d847d7b2733eab9b589879d5922a23167c33735582ee2021b0f46f96bc6'
