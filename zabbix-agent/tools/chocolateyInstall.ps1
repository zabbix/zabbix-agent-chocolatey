...
$id             = 'zabbix-agent'
$title          = 'Zabbix Agent'
$url            = 'https://cdn.zabbix.com/zabbix/binaries/stable/5.2/5.2.5/zabbix_agent-5.2.5-windows-i386-openssl.zip'
$url64          = 'https://cdn.zabbix.com/zabbix/binaries/stable/5.2/5.2.5/zabbix_agent-5.2.5-windows-amd64-openssl.zip'
$checksum       = '992837eede1ab483f3a9759d2f35035e0cf7115966bbb80f142625588fbad3a0'
$checksumType   = 'sha256'
$checksum64     = '158cce3ee41bdfed302764bfe19235a66640125f5635204b53a37a5e02c8cf2d'
