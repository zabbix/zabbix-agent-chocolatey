...
$id             = 'zabbix-agent'
$title          = 'Zabbix Agent'
$url            = 'https://www.zabbix.com/downloads/5.0.5/zabbix_agent-5.0.5-windows-i386-openssl.zip'
$url64          = 'https://www.zabbix.com/downloads/5.0.5/zabbix_agent-5.0.5-windows-amd64-openssl.zip'
