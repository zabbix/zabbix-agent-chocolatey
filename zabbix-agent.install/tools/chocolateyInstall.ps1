...
$packageArgs = @{
  ...
  FileType       = 'MSI'
  Url            = 'https://www.zabbix.com/downloads/5.0.5/zabbix_agent-5.0.5-windows-i386-openssl.msi'
  Url64bit       = 'https://www.zabbix.com/downloads/5.0.5/zabbix_agent-5.0.5-windows-amd64-openssl.msi'
